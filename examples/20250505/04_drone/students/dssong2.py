...
K_startend = lqr(A, B, Q_startend, Rc)
K_zigzag = lqr(A, B, Q_zigzag, Rc)
K_fasty = lqr(A, B, Q_fasty, Rc)
K_ringx = lqr(A, B, Q_ringx, Rc)
K_ringy = lqr(A, B, Q_ringy, Rc)
K_13 = lqr(A, B, Q_13, Rc)
